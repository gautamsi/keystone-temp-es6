...
function getSecret(req) {
    return req.session[exports.SECRET_KEY] || (req.session[exports.SECRET_KEY] = createSecret());
}
exports.getSecret = getSecret;
function createToken(req) {
    return tokenize(utils.randomString(exports.SECRET_LENGTH), getSecret(req));
}
exports.createToken = createToken;
function getToken(req, res) {
    res.locals[exports.LOCAL_VALUE] = res.locals[exports.LOCAL_VALUE] || createToken(req);
