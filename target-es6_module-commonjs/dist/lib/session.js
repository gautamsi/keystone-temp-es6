...
function setKeystone(_keystone) { keystone = _keystone; }
exports.setKeystone = setKeystone;
/**
 ...
 */
function signinWithUser(user, req, res, onSuccess, onFail) {
...
function signin(lookup, req, res, onSuccess, onFail) {
...
exports.keystoneAuth = keystoneAuth;
