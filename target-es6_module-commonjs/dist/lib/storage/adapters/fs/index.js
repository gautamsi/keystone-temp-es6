...
class FSAdapter {
    constructor(options, schema) {
        ...
        */
        this.getFilename = prototypeMethods.getFilename;
        this.retryFilename = prototypeMethods.retryFilename;
        if (!schema.filename)
            throw Error('Cannot use FSAdapter without storing filename');
