...
const constants_1 = require("../../admin/client/constants");
class Checkbox extends React.Component {
    ...
    getStyles() {
        ...
        if (active) {
            background = (checked && !readonly) ? color_1.darken(checkedColor, 20) : '#eee';
        ...
        if (focus && !active) {
            ...
            boxShadow = (checked && !readonly) ? `0 0 0 3px ${color_1.fade(checkedColor, 15)}` : `inset 0 1px 2px rgba(0,0,0,0.15), 0 0 0 3px ${color_1.fade(checkedColor, 15)}`;
        }
        // noedit
        if (readonly) {
        ...
        return {
            ...
            borderRadius: constants_1.borderRadius.sm,
            boxShadow: boxShadow,
            color: color,
