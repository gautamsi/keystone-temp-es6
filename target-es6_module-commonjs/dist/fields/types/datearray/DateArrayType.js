...
const addPresenceToQuery_1 = require("../../utils/addPresenceToQuery");
 ...
 * @api public
 */
class DateArrayType extends FieldTypeBase_1.FieldTypeBase {
    ...
    addFilterToQuery(filter) {
        const dateTypeAddFilterToQuery = DateType_1.DateType.prototype.addFilterToQuery.bind(this);
        const query = dateTypeAddFilterToQuery(filter);
        if (query[this.path]) {
            query[this.path] = addPresenceToQuery_1.addPresenceToQuery(filter.presence || 'some', query[this.path]);
        }
        return query;
    }
    /**
...
DateArrayType.properName = 'DateArray';
exports.DateArrayType = DateArrayType;
