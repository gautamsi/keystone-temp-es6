...
class HtmlField extends FieldBase_1.FieldBase {
    constructor(props) {
        super(props);
        ...
        this.state = Object.assign({ id: getId(), isFocused: false, wysiwygActive: false }, this.state);
    }
    initWysiwyg() {
    ...
    getOptions() {
        ...
        let options = Object.assign({}, Keystone.wysiwyg.options, this.props.wysiwyg);
    ...
    renderField() {
        ...
        return (React.createElement("div", { className: className },
            React.createElement(elemental_1.FormInput, { id: this.state.id, multiline: true, name: this.getInputName(this.props.path), onChange: this.valueChanged, className: this.props.wysiwyg ? 'wysiwyg' : 'code', style: style, value: this.props.value })));
    }
    renderValue() {
        return (React.createElement(elemental_1.FormInput, { multiline: true, noedit: true }, this.props.value));
    }
}
HtmlField.displayName = 'HtmlField';
HtmlField.type = 'Html';
