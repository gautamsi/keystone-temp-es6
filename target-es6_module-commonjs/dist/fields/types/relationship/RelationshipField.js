...
const lists_1 = require("../../../admin/client/utils/lists");
...
class RelationshipField extends FieldBase_1.FieldBase {
    constructor(props) {
        super(props);
    ...
    renderSelect(noedit) {
        return (React.createElement("div", null,
            ...
            React.createElement(react_select_1.default.Async, { multi: this.props.many, disabled: noedit, loadOptions: this.loadOptions, labelKey: "name", name: this.getInputName(this.props.path), onChange: this.valueChanged, simpleValue: true, value: this.state.value, valueKey: "id" })));
    }
    renderInputGroup() {
        ...
        return (React.createElement(elemental_1.InputGroup, { block: true },
            React.createElement(elemental_1.InputGroupSection, { grow: true }, this.renderSelect()),
            React.createElement(elemental_1.InputGroupSection, null,
                React.createElement(elemental_1.Button, { onClick: this.openCreate }, "+")),
            React.createElement(CreateForm, { list: lists_1.listsByKey[this.props.refList.key], isOpen: this.state.createIsOpen, onCreate: this.onCreate, onCancel: this.closeCreate })));
    }
    renderValue() {
        ...
        return many ? this.renderSelect(true) : React.createElement(elemental_1.FormInput, Object.assign({}, props));
    }
    renderField() {
