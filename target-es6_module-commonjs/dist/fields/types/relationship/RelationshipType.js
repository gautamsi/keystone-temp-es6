 ...
 * @api public
 */
class RelationshipType extends FieldTypeBase_1.FieldTypeBase {
    constructor(list, path, options) {
        super(list, path, options);
    }
    get isValid() {
        return keystone_1.keystone.list(this.options.ref) ? true : false;
    }
    // Returns the Related List
    get refList() {
        return keystone_1.keystone.list(this.options.ref);
    }
    ...
    init() {
        ...
        this._nativeType = keystone_1.keystone.mongoose.Schema.Types.ObjectId;
    ...
    addToSchema(schema) {
        ...
        schema.virtual(this.paths.refList).get(function () {
            return keystone_1.keystone.list(field.options.ref);
        });
    ...
    inputIsValid(data, required, item) {
        if (!required)
            return true;
        if (!(this.path in data) && item && ((this.many && item.get(this.path).length) || item.get(this.path)))
            return true;
...
RelationshipType.properName = 'Relationship';
