 ...
 * @api public
 */
class GeoPointType extends FieldTypeBase_1.FieldTypeBase {
    ...
    inputIsValid(data, required, item) {
        ...
        if (typeof values !== 'string')
            return false;
        if ((values === '' || values.charAt(0) === ',' || values.charAt(values.length - 1) === ',') && !required)
            return true;
...
GeoPointType.properName = 'GeoPoint';
