...
class MarkdownField extends FieldBase_1.FieldBase {
    ...
    renderField() {
        ...
        const defaultValue = (this.props.value !== undefined
            ...
            ? this.props.value.md
            : '';
        return (React.createElement("textarea", { className: "md-editor__input code", defaultValue: defaultValue, name: this.getInputName(this.props.paths.md), ref: "markdownTextarea", style: styles }));
    }
    renderValue() {
        ...
        const innerHtml = (this.props.value && this.props.value.md)
            ...
            : '';
        return (React.createElement(elemental_1.FormInput, { dangerouslySetInnerHTML: { __html: innerHtml }, multiline: true, noedit: true }));
    }
}
