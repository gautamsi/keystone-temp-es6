...
class CloudinaryImageField extends FieldBase_1.FieldBase {
    constructor(props) {
        super(props);
        // ==============================
        // HELPERS
        ...
        this.getImageSource = (height = 90) => {
            ...
            if (this.hasLocal()) {
                ...
                src = cloudinaryResize_1.cloudinaryResize(this.props.value.public_id, {
                    crop: 'fit',
                    height: height,
                    format: 'jpg',
    ...
    renderImagePreview() {
        ...
        return (React.createElement(ImageThumbnail_1.ImageThumbnail, { component: "a", href: this.getImageSource(600), onClick: shouldOpenLightbox ? this.openLightbox : undefined, mask: mask, target: "__blank", style: { float: 'left', marginRight: '1em' } },
    ...
    renderFileNameAndOptionalMessage(showChangeMessage = false) {
        return (React.createElement("div", null,
            this.hasImage() ? (React.createElement(FileChangeMessage_1.FileChangeMessage, null, this.getFilename())) : null,
    ...
    renderChangeMessage() {
        if (this.state.userSelectedFile) {
            ...
            return (React.createElement(FileChangeMessage_1.FileChangeMessage, { color: "danger" }, "Save to Remove"));
        }
        else {
            return null;
        }
    ...
    renderClearButton() {
        ...
        return this.state.removeExisting ? (React.createElement(elemental_1.Button, { variant: "link", onClick: this.undoRemove }, "Undo Remove")) : (React.createElement(elemental_1.Button, { variant: "link", color: "cancel", onClick: this.handleRemove }, clearText));
    }
    renderImageToolbar() {
    ...
    renderFileInput() {
        if (!this.shouldRenderField())
            return null;
        return (React.createElement(HiddenFileInput_1.HiddenFileInput, { accept: SUPPORTED_TYPES.join(), ref: "fileInput", name: this.state.uploadFieldPath, onChange: this.handleImageChange }));
    }
    renderActionInput() {
        if (!this.shouldRenderField())
            return null;
    ...
    renderUI() {
        ...
        return (React.createElement(elemental_1.FormField, { label: label, className: "field-type-cloudinaryimage", htmlFor: path },
            imageContainer,
            toolbar,
...
exports.CloudinaryImageField = CloudinaryImageField;
