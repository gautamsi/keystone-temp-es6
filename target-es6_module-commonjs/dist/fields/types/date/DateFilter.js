...
class DateFilter extends React.Component {
                ...
                React.createElement("div", { style: { marginBottom: '1em' } },
                    React.createElement(elemental_1.Grid.Row, { xsmall: "one-half", gutter: 10 },
                        React.createElement(elemental_1.Grid.Col, null,
                            React.createElement(elemental_1.FormInput, { autoFocus: true, ref: "after", placeholder: "From", onChange: this.handleInputChange, onFocus: () => this.setActiveField('after'), value: moment(filter.after).format(this.props.format) })),
                        React.createElement(elemental_1.Grid.Col, null,
                            React.createElement(elemental_1.FormInput, { ref: "before", placeholder: "To", onChange: this.handleInputChange, onFocus: () => this.setActiveField('before'), value: moment(filter.before).format(this.props.format) })))),
                React.createElement("div", { style: { position: 'relative' } },
                    React.createElement(react_day_picker_1.default, { modifiers: modifiers, className: "DayPicker--chrome", onDayClick: this.switchBetweenActiveInputFields }),
                    React.createElement(DayPickerIndicator, { activeInputField: activeInputField }))));
        }
        else {
            controls = (React.createElement("div", null,
                React.createElement("div", { style: { marginBottom: '1em' } },
                    React.createElement(elemental_1.FormInput, { autoFocus: true, ref: "input", placeholder: placeholder, value: moment(filter.value).format(this.props.format), onChange: this.handleInputChange, onFocus: this.showCurrentDate })),
                React.createElement("div", { style: { position: 'relative' } },
                    React.createElement(react_day_picker_1.default, { ref: "daypicker", modifiers: modifiers, className: "DayPicker--chrome", onDayClick: this.selectDay }),
    ...
    render() {
        ...
        return (React.createElement("div", null,
            this.renderToggle(),
            React.createElement("div", { style: { marginBottom: '1em' } },
                React.createElement(elemental_1.FormSelect, { options: MODE_OPTIONS, onChange: this.selectMode, value: mode.value })),
            this.renderControls()));
    }
}
