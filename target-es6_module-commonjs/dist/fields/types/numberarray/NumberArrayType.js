 ...
 * @api public
 */
class NumberArrayType extends FieldTypeBase_1.FieldTypeBase {
    ...
    addFilterToQuery(filter) {
        ...
        if (filter.mode === 'between') {
            ...
            if (!isNaN(min) && !isNaN(max)) {
                ...
                query[this.path] = addPresenceToQuery_1.addPresenceToQuery(presence, query[this.path]);
            }
            return query;
        }
...
NumberArrayType.properName = 'NumberArray';
exports.NumberArrayType = NumberArrayType;
