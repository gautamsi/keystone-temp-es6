...
class SigninView extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "auth-wrapper" },
            React.createElement(Alert_1.AlertView, { isInvalid: this.state.isInvalid, signedOut: this.state.signedOut, invalidMessage: this.state.invalidMessage }),
            React.createElement("div", { className: boxClassname },
                ...
                React.createElement("div", { className: "auth-box__inner" },
                    React.createElement(Brand_1.Brand, { logo: this.props.logo, brand: this.props.brand }),
                    this.props.user ? (React.createElement(UserInfo_1.UserInfo, { adminPath: this.props.from ? this.props.from : Keystone.adminPath, signoutPath: `${Keystone.adminPath}/signout`, userCanAccessKeystone: this.props.userCanAccessKeystone, userName: this.props.user.name })) : (React.createElement(LoginForm_1.LoginForm, { email: this.state.email, handleInputChange: this.handleInputChange, handleSubmit: this.handleSubmit, isAnimating: this.state.isAnimating, password: this.state.password })))),
