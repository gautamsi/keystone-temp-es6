...
class MobileNavigation extends React.Component {
    ...
    renderNavigation() {
        ...
        return this.props.sections.map((section) => {
            ...
            return (React.createElement(SectionItem_1.MobileSectionItem, { key: section.key, className: className, href: href, lists: section.lists, currentListKey: this.props.currentListKey, onClick: this.toggleMenu }, section.label));
        });
    }
    // Render a blockout
    renderBlockout() {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "MobileNavigation" },
            ...
            React.createElement(Transition_1.default, { classNames: "MobileNavigation__menu", timeout: 260 }, this.renderMenu()),
            React.createElement(Transition_1.default, { classNames: "react-transitiongroup-fade", timeout: 0 }, this.renderBlockout())));
    }
}
