...
const ItemsTableDragDropZoneTarget_1 = require("./ItemsTableDragDropZoneTarget");
const classnames = require("classnames");
/**
 * class ItemsTableDragDropZone
 */
class DropZone /*ItemsTableDragDropZone*//*ItemsTableDragDropZone*/  extends React.Component {
    renderPageDrops() {
        ...
        for (let i = 0; i < totalPages; i++) {
            ...
            pages.push(React.createElement(ItemsTableDragDropZoneTarget_1.DropZoneTarget, { key: 'page_' + page, page: page, className: className, pageItems: pageItems, pageSize: pageSize, currentPage: currentPage, drag: this.props.drag, dispatch: this.props.dispatch }));
        }
