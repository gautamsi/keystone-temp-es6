...
(function (theme) {
    ...
    theme.color = {
        body: '#fafafa',
        link: '#1385e5',
        linkHover: color_1.lighten('#1385e5', 10),
        text: '#1A1A1A',
        // contextual
        success: '#34c240',
        create: '#34c240',
    ...
    theme.button = {
        ...
        default: {
            ...
            borderColor: color_1.blend(theme.color.primary, theme.color.body, 60),
        ...
        success: {
            ...
            borderColor: color_1.blend(theme.color.success, theme.color.body, 60),
            textColor: theme.color.success,
        },
        warning: {
            bgColor: theme.color.warning,
            borderColor: color_1.blend(theme.color.warning, theme.color.body, 60),
            textColor: theme.color.warning,
        },
        danger: {
            bgColor: theme.color.danger,
            borderColor: color_1.blend(theme.color.danger, theme.color.body, 60),
            textColor: theme.color.danger,
        },
    };
    // blank state
    theme.blankstate = {
        background: color_1.darken(theme.color.body, 4),
        borderRadius: theme.borderRadius.default,
    ...
    theme.input = {
        background: {
            default: 'white',
            disabled: '#fafafa',
            noedit: color_1.darken(theme.color.body, 2),
        },
        ...
        border: {
            color: {
                ...
                hover: '#bbb',
                noedit: color_1.darken(theme.color.body, 8),
            },
            radius: theme.borderRadius.default,
            width: 1,
        },
        boxShadow: 'inset 0 1px 1px rgba(0, 0, 0, 0.075)',
        boxShadowFocus: `inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 3px ${color_1.fade(theme.color.info, 10)}`,
    ...
    theme.alert = {
        ...
        color: {
            danger: {
                background: color_1.fade(theme.color.danger, 10),
                border: color_1.fade(theme.color.danger, 10),
                text: theme.color.danger,
            },
            info: {
                background: color_1.fade(theme.color.primary, 10),
                border: color_1.fade(theme.color.primary, 10),
                text: theme.color.primary,
            },
            success: {
                background: color_1.fade(theme.color.success, 10),
                border: color_1.fade(theme.color.success, 10),
                text: theme.color.success,
            },
            warning: {
                background: color_1.fade(theme.color.warning, 10),
                border: color_1.fade(theme.color.warning, 10),
