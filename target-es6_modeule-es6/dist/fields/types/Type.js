...
const evalDependsOn_js_1 = require("../utils/evalDependsOn.js");
const definePrototypeGetters_js_1 = require("../utils/definePrototypeGetters.js");
...
class Field {
    constructor(list, path, options) {
        ...
        this.list = list;
        this._path = new path_1.Path(path);
        this.path = path;
        ...
        if (this.options.dependsOn && this.options.required === true) {
            ...
            this.options.required = function () {
                ...
                debug('validate dependsOn required', evalDependsOn_js_1.evalDependsOn(opts.dependsOn, this.toObject()));
                return evalDependsOn_js_1.evalDependsOn(opts.dependsOn, this.toObject());
            };
        }
            ...
            if (typeof this.options.watch === 'function') {
                ...
                applyValue = function (item) {
                    ...
                    _.forEach(field.options.watch, function (value, path) {
                        if (item.isModified(path) && item.get(path) === value)
                            pass = true;
                    });
                    return pass;
                };
...
definePrototypeGetters_js_1.definePrototypeGetters(Field, {
