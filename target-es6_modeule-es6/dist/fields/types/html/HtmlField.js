...
export class HtmlField extends FieldBase {
    ...
    renderField() {
        ...
        return (React.createElement("div", { className: className },
            React.createElement(FormInput, { id: this.state.id, multiline: true, name: this.getInputName(this.props.path), onChange: this.valueChanged, className: this.props.wysiwyg ? 'wysiwyg' : 'code', style: style, value: this.props.value })));
    }
    renderValue() {
        return (React.createElement(FormInput, { multiline: true, noedit: true }, this.props.value));
    }
}
