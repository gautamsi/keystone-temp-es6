                ...
                Object.keys(navSections).sort().map(section => {
                    ...
                    const types = navSections[section].map(type => {
                        ...
                        const itemClassName = params.type === type
                            ...
                            : 'fx-sidebar__item';
                        return (React.createElement(Link, { key: type, to: `/${type}`, className: itemClassName }, type));
                    });
...
ReactDOM.render(React.createElement(Router, { history: browserHistory },
    React.createElement(Route, { path: "/", component: App },
        ...
        React.createElement(Route, { path: ":type", component: FieldType }))), document.getElementById('explorer'));
