...
export class DateInput extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement(FormInput, { autoComplete: "off", id: this.state.id, name: this.props.name, 
                // @ts-ignore
            ...
            React.createElement(Popout, { isOpen: this.state.pickerIsOpen, onCancel: this.handleCancel, ref: "popout", relativeToID: this.state.id, width: 260 },
                React.createElement(DayPicker, { modifiers: modifiers, onDayClick: this.handleDaySelect, ref: "picker", 
                    // @ts-ignore
                    tabIndex: -1 }))));
    }
}
