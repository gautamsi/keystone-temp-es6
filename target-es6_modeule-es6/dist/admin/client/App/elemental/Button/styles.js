...
function buttonFillVariant(textColor, bgColor) {
    const hoverStyles = Object.assign({}, gradientVertical(lighten(bgColor, 10), darken(bgColor, 5)), { borderColor: `${darken(bgColor, 5)} ${darken(bgColor, 10)} ${darken(bgColor, 15)}`, boxShadow: '0 1px 0 rgba(0,0,0,0.1)', color: textColor, outline: 'none' });
    const focusStyles = Object.assign({}, gradientVertical(lighten(bgColor, 10), darken(bgColor, 5)), { borderColor: `${darken(bgColor, 5)} ${darken(bgColor, 10)} ${darken(bgColor, 15)}`, boxShadow: `0 0 0 3px ${fade(bgColor, 25)}`, color: textColor, outline: 'none' });
    const activeStyles = {
    ...
    return {
        base: Object.assign({}, gradientVertical(lighten(bgColor, 5), darken(bgColor, 10), bgColor), { 'borderColor': `${darken(bgColor, 10)} ${darken(bgColor, 20)} ${darken(bgColor, 25)}`, 'boxShadow': 'inset 0 1px 0 rgba(255, 255, 255, 0.1)', 'color': textColor, 'fontWeight': 400, 'textShadow': '0 -1px 0 rgba(0, 0, 0, 0.25)', ':hover': hoverStyles, ':focus': focusStyles, ':active': activeStyles }),
        active: activeStyles,
    };
}
...
function buttonFillDefault() {
    ...
    const hoverStyles = Object.assign({}, gradientVertical('#fff', '#eee'), { borderColor: `${darken(borderColor, 5)} ${darken(borderColor, 5)} ${darken(borderColor, 10)}`, boxShadow: '0 1px 0 rgba(0,0,0,0.1)', color: theme.color.text });
    const focusStyles = {
    ...
    return {
        base: Object.assign({}, gradientVertical('#fafafa', '#eaeaea'), { 'borderColor': `${borderColor} ${darken(borderColor, 6)} ${darken(borderColor, 12)}`, 'color': theme.color.text, 'textShadow': '0 1px 0 white', ':hover': hoverStyles, ':focus': focusStyles, ':active': activeStyles }),
        // gross hack
        active: Object.assign({}, activeStyles, { ':hover': activeStyles, ':focus': Object.assign({}, activeStyles, focusStyles, { boxShadow: `0 0 0 3px ${fade(theme.color.primary, 10)}, inset 0 1px 2px rgba(0, 0, 0, 0.1)` }), ':active': activeStyles }),
    };
}
...
function buttonLinkDelete() {
    ...
    const hoverStyles = Object.assign({}, gradientVertical(lighten(theme.color.danger, 10), darken(theme.color.danger, 10)), { backgroundColor: theme.color.danger, borderColor: `${darken(theme.color.danger, 4)} ${darken(theme.color.danger, 8)} ${darken(theme.color.danger, 12)}`, boxShadow: '0 1px 0 rgba(0,0,0,0.1)', color: 'white', textDecoration: 'none' });
    const activeStyles = {
