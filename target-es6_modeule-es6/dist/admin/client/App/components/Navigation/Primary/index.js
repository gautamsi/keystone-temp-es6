...
export class PrimaryNavigation extends React.Component {
    ...
    renderBackButton() {
        if (!Keystone.backUrl)
            return null;
        return (React.createElement(PrimaryNavItem, { label: "octicon-globe", href: Keystone.backUrl, title: 'Front page - ' + this.props.brand },
    ...
    renderBrand() {
        ...
        return (React.createElement(PrimaryNavItem, { className: className, label: "octicon-home", title: 'Dashboard - ' + brand, to: Keystone.adminPath },
    ...
    renderNavigation() {
        ...
        return this.props.sections.map((section) => {
            ...
            return (React.createElement(PrimaryNavItem, { active: isActive, key: section.key, label: section.label, className: className, to: href }, section.label));
        });
    }
    render() {
        ...
        return (React.createElement("nav", { className: "primary-navbar" },
            React.createElement(Container, { clearFloatingChildren: true },
