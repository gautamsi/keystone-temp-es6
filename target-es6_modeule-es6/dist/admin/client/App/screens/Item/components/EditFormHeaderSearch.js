...
export class EditFormHeaderSearch extends React.Component {
    ...
    render() {
        ...
        return focused ? (React.createElement("div", { className: `${css(classes.wrapper)}` },
            React.createElement(Glyph, { style: classes.glyph, color: theme.color.gray40, name: "search", "data-e2e-search-icon": true }),
            React.createElement(FormInput, Object.assign({ style: classes.input, name: "search", onBlur: () => this.setState({ focused: false }), onChange: onChange, onKeyUp: onKeyUp, placeholder: "Search", ref: "target", type: "search", value: value }, props)))) : (React.createElement(GlyphButton, { color: "primary", glyph: "search", glyphStyle: { marginRight: '0.4em' }, onClick: this.focusField, onFocus: this.focusField, position: "left", variant: "link", style: { paddingLeft: '0.7em' }, "data-e2e-search-icon": true }, "Search"));
    }
}
const classes = {
    wrapper: {
