...
import { SELECT_LIST, ITEMS_LOADED, LOAD_ITEMS, ITEM_LOADING_ERROR, SET_CURRENT_PAGE, QUERY_HAS_CHANGED, SET_ROW_ALERT, RESET_DRAG_PAGE, RESET_DRAG_ITEMS, SET_DRAG_ITEM, SET_DRAG_INDEX, DRAG_MOVE_ITEM, } from '../constants';
import { DELETE_ITEM, } from '../../Item/constants';
const initialState = {
    loadingRef: null,
    loadCounter: 0,
    currentList: null,
