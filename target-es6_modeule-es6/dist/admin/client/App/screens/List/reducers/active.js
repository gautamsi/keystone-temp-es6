...
import { ADD_FILTER, CLEAR_FILTER, CLEAR_ALL_FILTERS, SET_ACTIVE_SEARCH, SET_ACTIVE_SORT, SET_ACTIVE_COLUMNS, SET_ACTIVE_LIST, SET_FILTERS, QUERY_HAS_CHANGED, REPLACE_CACHED_QUERY, CLEAR_CACHED_QUERY, } from '../constants';
const initialState = {
    columns: [],
    filters: [],
    search: '',
