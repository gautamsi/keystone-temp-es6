...
import { setDragBase, resetItems, reorderItems, setRowAlert, moveItem, } from '../../actions';
export class TableRow extends React.Component {
    renderRow(item) {
        ...
        if (this.props.list.sortable) {
            cells.unshift(React.createElement(ListControl, { key: "_sort", type: "sortable", dragSource: this.props.connectDragSource }));
        }
        // add delete/check icon when applicable
        if (!this.props.list.nodelete) {
            cells.unshift(this.props.manageMode ? (React.createElement(ListControl, { key: "_check", type: "check", active: this.props.checkedItems[itemId] })) : (React.createElement(ListControl, { key: "_delete", onClick: (e) => this.props.deleteTableItem(item, e), type: "delete" })));
        }
