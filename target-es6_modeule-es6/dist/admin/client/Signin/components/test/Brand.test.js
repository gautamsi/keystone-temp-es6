...
describe('<Brand />', () => {
    ...
    it('should render the KeystoneJS logo by default', () => {
        const component = enzyme_1.shallow(React.createElement(Brand_1.Brand, null));
    ...
    it('should handle a different path to a logo', () => {
        ...
        const component = enzyme_1.shallow(React.createElement(Brand_1.Brand, { logo: logoUrl }));
    ...
    it('should handle changing the src of the logo when passed an object', () => {
        ...
        const component = enzyme_1.shallow(React.createElement(Brand_1.Brand, { logo: logo }));
